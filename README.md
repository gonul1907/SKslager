...
Kleine statische prototype-website voor een slager. Deze versie is gemaakt als voorbeeld zonder online bestellingen. Gebruik de bestanden in de root om te bekijken of verder uit te breiden.

Bestanden:
- `index.html` — homepage
- `ons-winkel.html` — over de winkel
- `fotos.html` — productoverzicht (Producten)
...
- Plaatsvervangende afbeeldingen komen vanaf nu uit de lokale map `images/`.
  ...
  - `images/photo1.jpg` ... `images/photo6.jpg` — extra afbeeldingen (optioneel); `fotos.html` is nu het productoverzicht
